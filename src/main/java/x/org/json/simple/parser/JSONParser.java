...
public class JSONParser extends NSObject {	
	...
	public Object parseWithStringwithContainerFactory(String arg0, Object arg1) throws org.json.simple.parser.ParseException {
	...
	public Object parseWithReaderwithContainerFactory(java.io.Reader arg0, Object arg1) throws java.io.IOException, org.json.simple.parser.ParseException {
		return original.parse(arg0, (org.json.simple.parser.ContainerFactory) arg1);		
	}	
	
	@Selector("parseWithString:withContentHandler:")	
	public void parseWithStringwithContentHandler(String arg0, Object arg1) throws org.json.simple.parser.ParseException {
		original.parse(arg0, (org.json.simple.parser.ContentHandler) arg1);		
	}	
	
	@Selector("parseWithString:withContentHandler:withBoolean:")	
	public void parseWithStringwithContentHandlerwithBoolean(String arg0, Object arg1, boolean arg2) throws org.json.simple.parser.ParseException {
		original.parse(arg0, (org.json.simple.parser.ContentHandler) arg1, arg2);		
	}	
	
	@Selector("parseWithReader:withContentHandler:")	
	public void parseWithReaderwithContentHandler(java.io.Reader arg0, Object arg1) throws java.io.IOException, org.json.simple.parser.ParseException {
		original.parse(arg0, (org.json.simple.parser.ContentHandler) arg1);		
	}	
	
	@Selector("parseWithReader:withContentHandler:withBoolean:")	
	public void parseWithReaderwithContentHandlerwithBoolean(java.io.Reader arg0, Object arg1, boolean arg2) throws java.io.IOException, org.json.simple.parser.ParseException {
		original.parse(arg0, (org.json.simple.parser.ContentHandler) arg1, arg2);		
	}	
}
